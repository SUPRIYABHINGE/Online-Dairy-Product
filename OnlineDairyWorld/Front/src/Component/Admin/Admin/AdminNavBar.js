                ...
                <nav className="navbar navbar-expand-lg py-0" style={{ backgroundColor: '#e3f2fd' }}>
                    <div className="container">
                        <a href="/admin" className="navbar-brand">
                            <img src="http://www.allinharidwar.com/library/timthumb.php?src=/wp-content/uploads/2014/07/products-img.png&h=380&zc=0&q=80" height="50" alt="CoolBrand" />
                        </a>
