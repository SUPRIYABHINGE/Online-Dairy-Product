...
function Register() {
    ...
    const registerUser = (e) => {
        ...
        if (!isValidPassword(password)) {
            toast.error('Password must be at least 8 characters and contain an uppercase letter, a lowercase letter, a number, and a special character!',
                {
                    style: {
                        borderRadius: '10px',
                        background: '#333',
                ...
                <div className="row justify-content-sm-center h-100">
                    <div className="col-xxl-6 col-xl-5 col-lg-5 col-md-7 col-sm-9">
                        <div className="text-center my-4">
                            <img src="https://dairyondemand.com/assets/images/logo/01.png" alt="logo" width="100" style={{ borderRadius: '50px' }} />
                        </div>
