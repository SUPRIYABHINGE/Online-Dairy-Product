...
function LoginForm() {
	...
	return (
		...
		<div style={{
            backgroundImage: 'url(https://wallpapercave.com/wp/wp9047024.jpg)', 
			...
			<div className="container h-100">
				<div className="row justify-content-sm-left h-100">
					<div className="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
						<div className="text-center my-5">
							<img src="https://dairyondemand.com/assets/images/logo/01.png" alt="logo" width="200" style={{ borderRadius: '10px' }} />
						</div>
