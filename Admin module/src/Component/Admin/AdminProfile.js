                    ...
                    <div className="row justify-content-sm-center h-100">
                        <div className="col-xxl-6 col-xl-5 col-lg-5 col-md-7 col-sm-9">
                            <div className="text-center my-4">
                                <img src="http://www.allinharidwar.com/library/timthumb.php?src=/wp-content/uploads/2014/07/products-img.png&h=380&zc=0&q=80" alt="logo" width="100" style={{ borderRadius: '50px' }} />
                            </div>
